...
const Drawer = ({ children, isOpen, setIsOpen }: any) => {
    ...
    return (
        <aside className={"fixed overflow-hidden z-10 inset-0 transform ease-in-out " +
            ...
            <section className={"w-[380px] right-14 top-1/2 translate-y-[-50%] absolute bg-white h-[80%] shadow-cs-2 delay-400 duration-500 ease-in-out transition-all transform  " +
