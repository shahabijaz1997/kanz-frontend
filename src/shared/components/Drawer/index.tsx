...
const Drawer = ({ children, isOpen, setIsOpen }: any) => {
    ...
    return (
        <aside className={"w-[380px] fixed top-0 h-full z-10 ease-in-out " + (isOpen ? " transition-opacity opacity-100 duration-500 right-12 " : " transition-all delay-500 opacity-0 right-[-380px] ")}>
