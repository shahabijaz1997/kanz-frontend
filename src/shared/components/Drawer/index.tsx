...
const Drawer = ({
  ...
  return (
    <aside
      className={`mt-[50px] ${drawerWidth} fixed top-0 h-full ease-in-out ${
        !isOpen ? "z-[-1]" : "z-[199]"
      }
    ${
      isOpen &&
      orientation !== "rtl" &&
      " transition-opacity opacity-100 duration-500 right-12 screen1200:right-6 "
    }
    ${
      isOpen &&
      orientation === "rtl" &&
      " transition-opacity opacity-100 duration-500 left-12 screen1200:left-6"
    }
    ${
      !isOpen &&
      orientation !== "rtl" &&
    ...
    ${
      !isOpen &&
      orientation === "rtl" &&
      " transition-all delay-500 opacity-0 left-[-380px] "
    }
    `}
    >
      <section
