            ...
            <aside className='w-full'>
              ...
              <div className='mt-5'>
                <span className=' flex items-center justify-center gap-5'>
                  ...
                  {convertStatusLanguage(state?.invite?.invite_type) ===
                    MemberInviteType.INVITE_RECEIVED &&
                ...
                <div className='flex-col justify-center items-center w-[100%]'>
                  <div className='flex items-center justify-center'>
                    <div className='font-medium text-2xl'>
                      {`${state?.portfolio_stats?.total_deals_closed_in_12_months} ${language?.v3?.investor?.last_12_months}`}
                    </div>
                  </div>
                  <div className='flex items-center justify-center'>
              ...
              {state?.limited_partners?.length > 0 ? (
                ...
                <div className='mt-4 italic text-[#737380] text-center'>
                  {language?.v3?.investor?.no_member_for_now}
                </div>
              )}
              ...
              {state?.general_partners?.length > 0 ? (
                <div className='mt-4 flex items-center justify-center mb-10'>
                  <div
                    className='flex-wrap items-center justify-center max-w-[45%]'
                    style={{ display: 'flex' }}
