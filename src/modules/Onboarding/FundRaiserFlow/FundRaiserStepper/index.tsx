        ...
        <form className="pt-8 mb-4 w-full">
          ...
          <div className="mb-8 w-full" ref={refInd}>
            ...
            <span className="relative">
              ...
              />
              <span
                className={`absolute top-[0px] flex items-center pr-2 pointer-events-none ${orientation === "rtl" ? "left-1" : "right-0"
                  }`}
                style={{ zIndex: 99 }}
              >
          ...
          <div className="mb-8 relative">
            ...
            <div className="relative inline-flex w-full">
              <input
                type="disabled"
                value={"https://"}
                className={`text-neutral-500 text-base font-normal check-background border-t border-b border-neutral-300 h-[42px] w-[70px] ${orientation === "rtl"
