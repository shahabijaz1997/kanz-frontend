        ...
        <main className="h-full max-h-full background-auth">
            ...
            <aside className="w-full flex items-center justify-center flex-col pt-12">
                ...
                <section className="w-full inline-flex items-center justify-between mt-16">
                    ...
                    <button disabled={!selectedInvest?.id ? true : false} className="text-white font-semibold rounded-md focus:outline-none focus:shadow-outline primary-bg h-[38px] w-[140px]" type="button" onClick={() => navigate("/complete-goals")}>
