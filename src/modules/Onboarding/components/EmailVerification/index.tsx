    ...
    return (
        <section className="w-[428px] max-w-md pt-[130px] screen500:max-w-[300px]">
            ...
            <form className="pt-8 pb-8 mb-4">
                <div className="mb-4">
                    <label className="block text-neutral-700 text-[14px] font-semibold mb-2 screen500:text-[12px]" htmlFor="code">Enter code</label>
                ...
                <div className="text-right text-neutral-500 font-normal text-[14px] screen500:text-[12px]">Code has been sent to your email (you@example.com) <span className="color-blue">Edit </span></div>
