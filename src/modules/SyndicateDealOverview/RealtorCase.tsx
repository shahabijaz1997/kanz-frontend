            ...
            <React.Fragment>
                <div className="w-full inline-flex justify-between items-center border-b-[1px] border-b-neutral-200 py-3">
                    ...
                    <div className="w-[80%] inline-block align-start">
                        <h3 className="text-neutral-900 font-medium text-sm pb-1">Selling Price</h3>
                        <p className="text-neutral-900 font-normal text-sm capitalize">${numberFormatter(10000)}</p>
                    </div>
                </div>
                <div className="w-full inline-flex justify-between items-center border-b-[1px] border-b-neutral-200 py-3">
                    <div className="bg-cbc-grey-sec rounded-md h-8 w-8 inline-block align-start inline-grid place-items-center">
                    ...
                    <div className="w-[80%] inline-block align-start">
                        <h3 className="text-neutral-900 font-medium text-sm pb-1">Expected Dividend Yield</h3>
                        <p className="text-neutral-900 font-normal text-sm capitalize">{comaFormattedNumber("100")}%</p>
                    </div>
                </div>
                <div className="w-full inline-flex justify-between items-center border-b-[1px] border-b-neutral-200 py-3">
                    <div className="bg-cbc-grey-sec rounded-md h-8 w-8 inline-block align-start inline-grid place-items-center">
                    ...
                    <div className="w-[80%] inline-block align-start">
                        <h3 className="text-neutral-900 font-medium text-sm pb-1">Expected Annual Appreciation</h3>
                        <p className="text-neutral-900 font-normal text-sm capitalize">{comaFormattedNumber("100")}%</p>
                    </div>
                </div>
                <div className="w-full inline-flex justify-between items-center border-b-[1px] border-b-neutral-200 py-3">
                    ...
                    <div className="w-[80%] inline-block align-start">
                        <h3 className="text-neutral-900 font-medium text-sm pb-1">Property on a Rent</h3>
                        <p className="text-neutral-900 font-normal text-sm capitalize">${numberFormatter(10000)} per month</p>
                    </div>
                </div>
            </React.Fragment>
        )
                ...
                {loading ? (
                    ...
                    <section className="bg-cbc-auth h-full p-[5rem] flex items-start" style={{ width: "calc(100% - 250px)" }}>
                        ...
                        <section className="w-[60%]">
                            ...
                            {/* Images Section */}
                            {deal?.docs?.length && <section className="h-[500px] rounded-[8px] overflow-hidden relative">
                                <aside className="w-full inline-flex gap-2 h-full">
                                    {deal?.docs[0]?.attachment_kind === FileType.PDF ? <embed src={deal?.docs[0]?.url} className="h-full w-1/2 border-[1px] border-neutral-200 shadow shadow-cs-1  rounded-[8px]"></embed> : <img src={deal?.docs[0]?.url} alt={deal?.docs[0]?.name} className="h-full w-1/2 border-[1px] border-neutral-200 shadow shadow-cs-1  rounded-[8px]" />}
                                    <div className="inline-flex flex-col justify-between h-full w-1/2 overflow-hidden">
                                        {deal?.docs[1]?.attachment_kind === FileType.PDF ? <embed src={deal?.docs[1]?.url} className="w-full h-[48%] border-[1px] border-neutral-200 shadow shadow-cs-1 rounded-[8px]"></embed> : <img src={deal?.docs[1]?.url} alt={deal?.docs[1]?.name} className="w-full h-[48%] border-[1px] shadow shadow-cs-1  border-neutral-200 rounded-[8px]" />}
                                        {deal?.docs[2]?.attachment_kind === FileType.PDF ? <embed src={deal?.docs[2]?.url} className="w-full h-[48%] border-[1px] border-neutral-200 shadow shadow-cs-1  rounded-[8px]"></embed> : <img src={deal?.docs[2]?.url} alt={deal?.docs[2]?.name} className="w-full h-[48%] border-[1px] border-neutral-200 shadow shadow-cs-1  rounded-[8px]" />}
                                    </div>
                                </aside>
                                <Button prefix={<img src={ImgSVG} />} className="absolute right-2 bottom-2 !py-1 bg-white border-[1px] border-gray-900 !text-gray-900 hover:!bg-white !font-normal">View all photos</Button>
                            </section>}
                            ...
                            <aside className="border-[1px] border-neutral-200 rounded-md w-full p-3 mt-5 flex justify-between">
                                <section className="inline-flex flex-col items-start justify-start">
                                    <small className="text-neutral-500 text-sm font-medium mb-2">Bedrooms</small>
                                ...
                                <section className="inline-flex flex-col items-start justify-start">
                                    <small className="text-neutral-500 text-sm font-medium mb-2">Kitchen</small>
                                    <span className="inline-flex items-center gap-2">
                                ...
                                <section className="inline-flex flex-col items-start justify-start">
                                    <small className="text-neutral-500 text-sm font-medium mb-2">Washroom</small>
                                    <span className="inline-flex items-center gap-2">
                                ...
                                <section className="inline-flex flex-col items-start justify-start">
                                    <small className="text-neutral-500 text-sm font-medium mb-2">Parking Space</small>
                                    <span className="inline-flex items-center gap-2">
                                ...
                                <section className="inline-flex flex-col items-start justify-start">
                                    <small className="text-neutral-500 text-sm font-medium mb-2">Swimming Pool</small>
                                    <span className="inline-flex items-center gap-2">
                            ...
                            <section className="mt-10 rounded-md px-5 py-3 mb-6">
                                ...
                                <div className="inline-block w-[80%] align-top">
                                    <div className="font-bold text-neutral-900 text-sm mb-2">3% Cashback Offer using promo code: BB24</div>
                                    <small className="text-neutral-700 font-normal text-sm block w-full">Secure your investment within the first 24 hours, and you'll enjoy an exclusive cashback offer</small>
                                </div>
                            </section>
