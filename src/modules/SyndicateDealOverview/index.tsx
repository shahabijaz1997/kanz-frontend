          ...
          >
            ...
            <section className="w-[60%]">
              ...
              <div
                ...
                onClick={() => {
                  window.open(
                    "https://i.insider.com/638a2fb0edf6e10018e876f8?width=700&format=jpeg&auto=webp",
                    "_blank"
                  );
                }}
              >
              ...
              <section className="h-[500px] rounded-[8px] overflow-hidden border-[1px] border-neutral-200">
                <div className="bg-white w-full h-16 inline-flex items-center px-4 border-b-[1px] border-b-neutral-200">
                  ...
                  <Chevrond
                    ...
                    className={`mx-3 h-8 w-8 rotate-90 ${
                      docs.length > 1 ? "cursor-pointer" : "cursor-not-allowed"
                    }`}
                    stroke="#404040"
                  />
                ...
                >
                  <img
                    src="https://i.insider.com/638a2fb0edf6e10018e876f8?width=700&format=jpeg&auto=webp"
                    id="deal-image"
                    alt=""
