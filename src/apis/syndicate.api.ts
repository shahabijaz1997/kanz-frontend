...
export const getGroupInvestors = (
  token: any,
  filters: any,
  searchQuery: string,
  currentPage: number
  ...
  if (filters !== 'all') queryParameters.append('role', filters.toLowerCase());
  if (searchQuery.trim() !== '') {
    queryParameters.append('search', searchQuery);
  }
  const apiUrl = `${ENV.API_URL}/${
    ENV.API_VERSION
  }/syndicate_members?${queryParameters.toString()}`;
...
export const putChangeMemberRole = (
  investorID: any,
  payload: any,
  token: string
) => {
...
export const getInvitesSent = (
  ...
  const apiUrl = `${ENV.API_URL}/${
    ENV.API_VERSION
  }/syndicate_members/invites?${queryParameters.toString()}`;
  return axios.get(apiUrl, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
export const getSyndicatetoInvite = (
  dealId: any,
  searchQuery: string,
  token: string
) => {
  ...
  const apiUrl = `${ENV.API_URL}/${
    ENV.API_VERSION
  }/deals/${dealId}/syndicates?${queryParameters.toString()}`;
  return axios.get(apiUrl, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
export const getDealInvestors = (
  ...
  const apiUrl = `${ENV.API_URL}/${
    ENV.API_VERSION
  }/deals/${dealId}/investments?${queryParameters.toString()}`;
  return axios.get(apiUrl, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
export const getDealActivity = (
  ...
  const apiUrl = `${ENV.API_URL}/${
    ENV.API_VERSION
  }/deals/${dealId}/activities?${queryParameters.toString()}`;
  return axios.get(apiUrl, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
export const getSyndicates = (
  ...
  const apiUrl = `${ENV.API_URL}/${
    ENV.API_VERSION
  }/syndicates/all?${queryParameters.toString()}`;
  return axios.get(apiUrl, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
export const getAppliedSyndicates = (
  token: string,
  searchQuery: string,
  currentPage: number,
  filters: any
...
export const getNonAddedInvestors = (
  token: string,
  searchQuery: any,
  currentPage: number,
  filters: any
  ...
  const apiUrl = `${ENV.API_URL}/${
    ENV.API_VERSION
  }/syndicate_members/investors?${queryParameters.toString()}`;
  return axios.get(apiUrl, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
export const postInviteInvestor = (
  payload: any,
  investorID: any,
  token: string
) => {
  return axios.post(
    `${ENV.API_URL}/${ENV.API_VERSION}/syndicates/${investorID}/invites`,
    payload,
    {
      headers: {
        Authorization: `Bearer ${token}`,
...
export const getInvestorInfo = (token: string, investorID: any) => {
  return axios.get(
    `${ENV.API_URL}/${ENV.API_VERSION}/syndicate_members/${investorID}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export const getInvestorAllInfo = (token: string, investorID: any) => {
  return axios.get(
    `${ENV.API_URL}/${ENV.API_VERSION}/investors/${investorID}/details`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export const getInvitedSyndicates = (
  userId: any,
  searchQuery: string,
  token: string,
  currentPage: number,
  ...
  const apiUrl = `${ENV.API_URL}/${
    ENV.API_VERSION
  }/users/${userId}/invites?${queryParameters.toString()}`;
  return axios.get(apiUrl, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
export const getInvitedInvestors = (
  userId: any,
  searchQuery: string,
  token: string
) => {
...
export const getApplications = (token: string, searchQuery: string) => {
  ...
  const apiUrl = `${ENV.API_URL}/${
    ENV.API_VERSION
  }/syndicate_members/applications?${queryParameters.toString()}`;
  return axios.get(apiUrl, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
export const postApproveRequest = (
  ...
  return axios.post(
    `${ENV.API_URL}/${ENV.API_VERSION}/invites/${investorID}/syndicate_groups`,
    payload,
    {
      headers: {
        Authorization: `Bearer ${token}`,
...
export const delRemoveInvestor = (
  currSyndID: any,
  investorID: any,
  token: string
) => {
...
export const postDealUpdate = (payload: any, token: string) => {
  return axios.post(`${ENV.API_URL}/${ENV.API_VERSION}/deal_updates`, payload, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
